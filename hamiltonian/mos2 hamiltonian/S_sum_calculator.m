function [ S1,S2 ] = S_sum_calculator( k1,k2,k3 )
...
for i = 1: 13
    for j = 1:13
        S1(i,j+13*1) = S121(i,j);
        S2(i,j+13*1) = S122(i,j);
    end
end

for i = 1: 13
    for j = 1:13
        S1(i,j+13*2) = S131(i,j);
        S2(i,j+13*2) = S132(i,j);
    end
end
...
for i = 1: 13
    for j = 1:13
        S1(i+13,j+13) = S221(i,j);
        S2(i+13,j+13) = S222(i,j);
    end
end

for i = 1: 13
    for j = 1:13
        S1(i+13,j+13*2) = S231(i,j);
        S2(i+13,j+13*2) = S232(i,j);
    end
end

for i = 1: 13
    for j = 1:13
        S1(i+13*2,j) = S311(i,j);
        S2(i+13*2,j) = S312(i,j);
    end
end

for i = 1: 13
    for j = 1:13
        S1(i+13*2,j+13) = S321(i,j);
        S2(i+13*2,j+13) = S322(i,j);
    end
end

for i = 1: 13
    for j = 1:13
        S1(i+13*2,j+13*2) = S331(i,j);
        S2(i+13*2,j+13*2) = S332(i,j);
    end
end
